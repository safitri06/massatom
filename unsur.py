...
add_selectbox = st.sidebar.selectbox(
    "Menu",("Home","Tentang Massa Atom Relatif", "Aplikasi", "Perhitungan","Contoh Soal"))
if add_selectbox=="Home":
    
    image = Image.open('Welcome to the App.jpg')
    st.image(image)
    ...
    st.subheader ("Apa itu massa atom relatif?")
    ...
    st.title("Aplikasi Mengetahui Massa Atom Relatif Unsur")
